...
<div>
	<div
		class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 p-4 z-50"
	...
	>
		{#each Object.keys(navLinks) as navKey}
			{#if showHome && navKey == 'home'}<a
				...
				>
					<button
						class="border border-slate-300 bg-gray-900 hover:bg-gray-800 fill-slate-300 px-4 py-2 rounded-lg flex flex-col items-center justify-center"
