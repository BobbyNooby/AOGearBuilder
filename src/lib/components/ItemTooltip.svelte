<script lang="ts">
	...
	let itemStats = {
		...
		attackSpeedIncrement: { name: 'ATTACK SPEED', fillColor: '#FFFFFF', strokeColor: '#0077ff', suffix: '' },
		attackSizeIncrement: { name: 'ATTACK SIZE', fillColor: '#00FF00', strokeColor: '#471559', suffix: '' },
		intensityIncrement: { name: 'INTENSITY', fillColor: '#FFF200', strokeColor: '#712402', suffix: '' },
	...
	let efficiencyPoints = (Item["power"]*3)+Item["attackSpeed"]+Item["attackSize"]+Item["intensity"]+Item["agility"]+(Item["defense"]/3)+(Item["warding"]*18)-(Item["insanity"]*36)-(Item["drawback"]*18);
