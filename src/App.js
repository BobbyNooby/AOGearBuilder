        ...
        <div class="column"> {/* Final stat calculation box*/}
          ...
          <div>
            <p class="defenseResult">
              ...
              <span id="defense">
                {
                  accessory1.defense + Math.floor(accessory1.levelMultiplier * enchant1.defense) + acc1gem1.defense + acc1gem2.defense + acc1gem3.defense + (((accessory1.power + acc1gem1.power + acc1gem2.power + acc1gem3.power) > 0) ? (Math.floor(modifier1.defense * accessory1.levelMultiplier)) : 0) +
                  accessory2.defense + Math.floor(accessory2.levelMultiplier * enchant2.defense) + acc2gem1.defense + acc2gem2.defense + acc2gem3.defense + (((accessory2.power + acc2gem1.power + acc2gem2.power + acc2gem3.power) > 0) ? (Math.floor(modifier2.defense * accessory2.levelMultiplier)) : 0) +
                  accessory3.defense + Math.floor(accessory3.levelMultiplier * enchant3.defense) + acc3gem1.defense + acc3gem2.defense + acc3gem3.defense + (((accessory3.power + acc3gem1.power + acc3gem2.power + acc3gem3.power) > 0) ? (Math.floor(modifier3.defense * accessory3.levelMultiplier)) : 0) +
                  chestplate1.defense + Math.floor(chestplate1.levelMultiplier * enchant4.defense) + chest1gem1.defense + chest1gem2.defense + chest1gem3.defense + (((chestplate1.power + chest1gem1.power + chest1gem2.power + chest1gem3.power) > 0) ? (Math.floor(modifier4.defense * chestplate1.levelMultiplier)) : 0) +
                  pants1.defense + Math.floor(pants1.levelMultiplier * enchant5.defense) + pants1gem1.defense + pants1gem2.defense + pants1gem3.defense + (((pants1.power + pants1gem1.power + pants1gem2.power + pants1gem3.power) > 0) ? (Math.floor(modifier5.defense * pants1.levelMultiplier)) : 0)
                }
              </span> DEFENSE</p>
          </div>
          ...
          <div>
            <p class="agilityResult">
              ...
              <span id="agility">
                {
                  accessory1.agility + Math.floor(accessory1.levelMultiplier * enchant1.agility) + acc1gem1.agility + acc1gem2.agility + acc1gem3.agility + ((((accessory1.power + acc1gem1.power + acc1gem2.power + acc1gem3.power) > 0) && ((accessory1.defense + acc1gem1.defense + acc1gem2.defense + acc1gem3.defense) > 0) && ((accessory1.attackSize + acc1gem1.attackSize + acc1gem2.attackSize + acc1gem3.attackSize) > 0) && ((accessory1.attackSpeed + acc1gem1.attackSpeed + acc1gem2.attackSpeed + acc1gem3.attackSpeed) > 0)) ? (Math.floor(modifier1.agility * accessory1.levelMultiplier)) : 0) +
                  accessory2.agility + Math.floor(accessory2.levelMultiplier * enchant2.agility) + acc2gem1.agility + acc2gem2.agility + acc2gem3.agility + ((((accessory2.power + acc2gem1.power + acc2gem2.power + acc2gem3.power) > 0) && ((accessory2.defense + acc2gem1.defense + acc2gem2.defense + acc2gem3.defense) > 0) && ((accessory2.attackSize + acc2gem1.attackSize + acc2gem2.attackSize + acc2gem3.attackSize) > 0) && ((accessory2.attackSpeed + acc2gem1.attackSpeed + acc2gem2.attackSpeed + acc2gem3.attackSpeed) > 0)) ? (Math.floor(modifier2.agility * accessory2.levelMultiplier)) : 0) +
                  accessory3.agility + Math.floor(accessory3.levelMultiplier * enchant3.agility) + acc3gem1.agility + acc3gem2.agility + acc3gem3.agility + ((((accessory3.power + acc3gem1.power + acc3gem2.power + acc3gem3.power) > 0) && ((accessory3.defense + acc3gem1.defense + acc3gem2.defense + acc3gem3.defense) > 0) && ((accessory3.attackSize + acc3gem1.attackSize + acc3gem2.attackSize + acc3gem3.attackSize) > 0) && ((accessory3.attackSpeed + acc3gem1.attackSpeed + acc3gem2.attackSpeed + acc3gem3.attackSpeed) > 0)) ? (Math.floor(modifier3.agility * accessory3.levelMultiplier)) : 0) +
                  chestplate1.agility + Math.floor(chestplate1.levelMultiplier * enchant4.agility) + chest1gem1.agility + chest1gem2.agility + chest1gem3.agility + ((((chestplate1.power + chest1gem1.power + chest1gem2.power + chest1gem3.power) > 0) && ((chestplate1.defense + chest1gem1.defense + chest1gem2.defense + chest1gem3.defense) > 0) && ((chestplate1.attackSize + chest1gem1.attackSize + chest1gem2.attackSize + chest1gem3.attackSize) > 0) && ((chestplate1.attackSpeed + chest1gem1.attackSpeed + chest1gem2.attackSpeed + chest1gem3.attackSpeed) > 0)) ? (Math.floor(modifier4.agility * chestplate1.levelMultiplier)) : 0) +
                  pants1.agility + Math.floor(pants1.levelMultiplier * enchant5.agility) + pants1gem1.agility + pants1gem2.agility + pants1gem3.agility + ((((pants1.power + pants1gem1.power + pants1gem2.power + pants1gem3.power) > 0) && ((pants1.defense + pants1gem1.defense + pants1gem2.defense + pants1gem3.defense) > 0) && ((pants1.attackSize + pants1gem1.attackSize + pants1gem2.attackSize + pants1gem3.attackSize) > 0) && ((pants1.attackSpeed + pants1gem1.attackSpeed + pants1gem2.attackSpeed + pants1gem3.attackSpeed) > 0)) ? (Math.floor(modifier5.agility * pants1.levelMultiplier)) : 0)
                }
              </span> AGILITY</p>
          </div>
          ...
          <div>
            ...
            <span id="attacksize">
              {
                accessory1.attackSize + Math.floor(accessory1.levelMultiplier * enchant1.attackSize) + acc1gem1.attackSize + acc1gem2.attackSize + acc1gem3.attackSize + ((((accessory1.power + acc1gem1.power + acc1gem2.power + acc1gem3.power) > 0) && ((accessory1.defense + acc1gem1.defense + acc1gem2.defense + acc1gem3.defense) > 0)) ? (Math.floor(modifier1.attackSize * accessory1.levelMultiplier)) : 0) +
                accessory2.attackSize + Math.floor(accessory2.levelMultiplier * enchant2.attackSize) + acc2gem1.attackSize + acc2gem2.attackSize + acc2gem3.attackSize + ((((accessory2.power + acc2gem1.power + acc2gem2.power + acc2gem3.power) > 0) && ((accessory2.defense + acc2gem1.defense + acc2gem2.defense + acc2gem3.defense) > 0)) ? (Math.floor(modifier2.attackSize * accessory2.levelMultiplier)) : 0) +
                accessory3.attackSize + Math.floor(accessory3.levelMultiplier * enchant3.attackSize) + acc3gem1.attackSize + acc3gem2.attackSize + acc3gem3.attackSize + ((((accessory3.power + acc3gem1.power + acc3gem2.power + acc3gem3.power) > 0) && ((accessory3.defense + acc3gem1.defense + acc3gem2.defense + acc3gem3.defense) > 0)) ? (Math.floor(modifier3.attackSize * accessory3.levelMultiplier)) : 0) +
                chestplate1.attackSize + Math.floor(chestplate1.levelMultiplier * enchant4.attackSize) + chest1gem1.attackSize + chest1gem2.attackSize + chest1gem3.attackSize + ((((chestplate1.power + chest1gem1.power + chest1gem2.power + chest1gem3.power) > 0) && ((chestplate1.defense + chest1gem1.defense + chest1gem2.defense + chest1gem3.defense) > 0)) ? (Math.floor(modifier4.attackSize * chestplate1.levelMultiplier)) : 0) +
                pants1.attackSize + Math.floor(pants1.levelMultiplier * enchant5.attackSize)  + pants1gem1.attackSize + pants1gem2.attackSize + pants1gem3.attackSize + ((((pants1.power + pants1gem1.power + pants1gem2.power + pants1gem3.power) > 0) && ((pants1.defense + pants1gem1.defense + pants1gem2.defense + pants1gem3.defense) > 0)) ? (Math.floor(modifier5.attackSize * pants1.levelMultiplier)) : 0)
              }
            </span> ATTACK SIZE</p>
          </div>
